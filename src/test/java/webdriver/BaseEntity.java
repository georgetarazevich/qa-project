...
public abstract class BaseEntity {
    ...
    /**
     * Assert Expected greater or equal Actual
     *
     * @param expected Expected Value
     * @param actual   Actual Value
     */
    public void assertGreaterThanOrEqual(final Double expected, final Double actual) {
        String message = "Greater than expected value: '" + expected + "', but was: '" + actual + "'";         
        assertTrue(message, expected >= actual);  
    }
    
    /**
     * Assert Expected greater then Min and Less then Max
     *
     * @param expected Expected Value
     * @param min     Minimal  Value
     * @param max     Maximal  Value
     */
    public void assertGreaterThanAndLessThen(final Double expected, final Double min, final Double max) {
        String message = "Between expected value: '" + expected + "', but was: '" + min + max + "'";         
        assertTrue(message, (min < expected && expected < max));  
    }
    
    /**
     * Assert Expected less Actual
     *
     * @param expected Expected Value
     * @param actual   Actual Value
     */
    public void assertLessThan(final Double expected, final Double actual) {
        String message = "Less than expected value: '" + expected + "', but was: '" + actual + "'";         
        assertTrue(message, expected < actual);  
    }
